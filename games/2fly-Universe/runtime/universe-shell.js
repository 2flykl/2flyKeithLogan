...
import { InterstellarCurrents } from './scene/interstellar-currents.js';
...
export async function initUniverseShell(canvas) {
  ...
  `;
    ...
    canvas.addEventListener('pointermove', (e) => {
        ...
        zoomReticle.style.opacity = '0.82';
    });
                ...
                if (childId) {
                    ...
                    if (childData) {
                        ...
                        travelToWorldAndSnap(wp, 600, {
                            onDone: () => openMediaOverlay(childData)
                        });
                    }
                    return;
                }
