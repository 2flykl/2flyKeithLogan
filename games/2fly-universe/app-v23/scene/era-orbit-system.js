...
export class EraOrbitSystem {
    ...
    constructor(galaxyId) {
        ...
        defs.forEach((def, i) => {
            ...
            this.orbiters.push({ pivot, body, speed: def.speed });
        ...
        const light = new THREE.PointLight(theme.accentColor, 1.5, 14000);
    ...
    update(dt) {
        for (const o of this.orbiters) {
            o.pivot.rotation.y += dt * o.speed * 0.72;
            o.body.rotation.y += dt * 0.1;
        }
    }
}
