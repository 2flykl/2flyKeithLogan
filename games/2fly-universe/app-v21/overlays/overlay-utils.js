...
export function createOverlayEl(id, className) {
...
export function trapFocus(el) {
    const focusable = el.querySelectorAll('button,a,[tabindex]:not([tabindex="-1"]),input,textarea,select');
...
export function addCloseButton(container, onClose) {
