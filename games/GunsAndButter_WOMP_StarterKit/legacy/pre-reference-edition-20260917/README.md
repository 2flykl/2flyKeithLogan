...
## Realism remaster
The three WOMPs now have detailed beveled metal bodies, instrument mechanisms, textured grips, and distinct projectile effects. The target area is a lit industrial acoustic-testing hall with concrete, physical target plates, floor rails and machinery. See GRAPHICS_REMASTER.md for the designs, rendering choices and QA evidence.
