...
function experienceData(){
  ...
  return [
    {id:'fire',projectId:'fire',title:'Thru the Fire',word:'RESILIENCE',glyph:'🔥',cover:get('fire').cover,path:'games/thru-the-fire/index.html',description:'A cinematic pressure test about memory, value, and what you save when every second matters.',objective:'Rotate through the burning rooms, identify what can still be saved, and leave before time expires.',mechanics:['360° room views','Timed decisions','UP to grab','Permanent missed-items list']},
    ...
    {id:'guns',projectId:'gettin',title:'Guns & Butter',word:'CREATION',glyph:'🎛',cover:get('gettin').cover,path:'games/GunsAndButter_WOMP_StarterKit/index.html',description:'Enter a walkable museum and operate the Tambourine Tempest in its target pavilion.',objective:'Explore the exhibit, inspect the instrument, and strike the resonance plates.',mechanics:['First-person museum','Playable Tempest','Target range','45-second recital']}
  ];
}
